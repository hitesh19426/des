                        ...
                        <Accordion.Body id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div>
                                <nav class="nav flex-column">
                                    <a href="/hc_np"  class="nav-link active" aria-current="page"> Electonics </a>
                                    <a href="/hc_table3" class="nav-link"> Computer Science </a>
                                    <a href="#" class="nav-link"> Electrical  </a>
                                    <a href="/hc_table4" class="nav-link"> Mechanical </a>
                                </nav>
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
